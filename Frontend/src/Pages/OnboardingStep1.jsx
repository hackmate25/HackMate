...
export default function OnboardingStep1({ onNext, onBack }) {
  ...
  return (
    <div className="min-h-screen w-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 to-blue-200 font-sans px-4">
      {/* Progress Bar */}
      <div className="w-full max-w-2xl -mt-15 mb-15">
      ...
      {/* Content Section */}
      <div className="flex flex-col md:flex-row w-full max-w-2xl gap-4 md:gap-6">
        {/* Left panel */}
        <div className="bg-blue-800 text-white p-6 sm:p-10 rounded-2xl flex items-center justify-center md:w-1/3 flex-shrink-0">
          <h2 className="text-lg sm:text-2xl font-bold tracking-widest text-center md:whitespace-nowrap">
            Let's Know You More!
          </h2>
        </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100">
      ...
      <div className="lg:ml-72 pt-14 lg:pt-0 max-w-7xl mx-auto py-10 px-4 sm:px-6">
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl overflow-hidden flex h-[75vh] shadow-2xl border border-white/20">
          ...
          {/* LEFT SIDEBAR */}
          <div className="w-full lg:w-[30%] bg-gradient-to-b from-blue-100 to-indigo-100 border-r border-white/50 overflow-y-auto">
            <div className="p-5 font-bold text-xl text-gray-800 border-b border-white/50 flex items-center gap-2 sticky top-0 bg-blue-100/80 backdrop-blur-sm">
                ...
                {chats.map((chat, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`flex items-center gap-3 px-4 py-4 cursor-pointer transition-all duration-200 border-b border-white/30 ${
                    ...
                    >
                      <motion.div
                        ...
                        className="w-12 h-12 rounded-full bg-gradient-to-br from-blue-400 to-indigo-500 flex items-center justify-center text-white font-bold shadow-md flex-shrink-0"
                      >
          ...
          <div className="hidden lg:flex flex-1 bg-gradient-to-b from-blue-50 to-white flex-col items-center justify-center">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
